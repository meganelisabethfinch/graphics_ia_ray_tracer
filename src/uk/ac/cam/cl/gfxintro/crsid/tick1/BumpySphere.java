...
public class BumpySphere extends Sphere {
	...
	public Vector3 getNormalAt(Vector3 position) {
		// position is a point on the sphere

		Vector3 P = position; // point on the sphere
		Vector3 C = getPosition(); // centre of the sphere
        Vector3 n = P.subtract(C).normalised(); // unit normal of sphere
